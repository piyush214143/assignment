...
<ScrollView>
            ...
            {/* <View style={{flexDirection:"row" , justifyContent:"space-between" , alignItems:"center" , marginTop:10}}>
                <Text style={{color:"black" , fontWeight:"bold" , fontSize:16}}>Vendor Name :</Text>
                <TextInput
                  placeholder='Enter Name'
                  placeholderTextColor={"grey"}
                  value={userName}
                  onChangeText={setVendorName}
                  style={{  width: wp("40%"), color:"black" , borderWidth: 1, marginTop:20 ,paddingVertical:-20, borderColor: "black" }}/>
            </View> */}
