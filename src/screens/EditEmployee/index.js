...
console.log(userData , "jfkdjfkdjflkjdslkf==========>>.")
...
<ScrollView>
            <Text style={{ color: "black", textAlign: "center", marginTop: hp("4%"), fontSize: 20, fontWeight: "bold" }}>Edit Employee</Text>
            ...
            <View style={{marginTop:10 }}>
                <Text style={{color:"black" , fontWeight:"bold" , fontSize:16}}>Role :</Text>
